    ...
    <div class="page-banner home-banner">
      <div class="container h-100">
        <div class="row align-items-center h-100">
          <div v-motion-slide-visible-once-left class="col-lg-6 py-3 wow fadeInUp">
            ...
            <p class=" hidden lg:block text-2xl mb-5">
          ...
          <div v-motion-slide-visible-once-right class="col-lg-6  wow zoomIn">
            <div class="m-3 lg:m-3 p-1 lg:p-5 ">
              <lottie-player
